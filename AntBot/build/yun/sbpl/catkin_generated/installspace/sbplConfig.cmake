...
if("FALSE" STREQUAL "TRUE")
  set(sbpl_SOURCE_PREFIX /home/pepper/AntBot/src/yun/sbpl)
  set(sbpl_DEVEL_PREFIX /home/pepper/AntBot/devel)
  set(sbpl_INSTALL_PREFIX "")
  set(sbpl_PREFIX ${sbpl_DEVEL_PREFIX})
else()
  set(sbpl_SOURCE_PREFIX "")
  set(sbpl_DEVEL_PREFIX "")
  set(sbpl_INSTALL_PREFIX /home/pepper/AntBot/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sbpl' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pepper/AntBot/install/${idir}'.  Ask the maintainer 'Michael Ferguson <mike@vanadiumlabs.com>' to fix it.")
    endif()
