...
#2、监听串口，接收arduino的发送的轮子的速度信息，并转化为odom信息，在antbot_speed这个话题上发布出去
...
from antbot_bringup.msg import antbotOdom
...
def listener():
        ...
        pub = rospy.Publisher("antbot_speed",antbotOdom, queue_size=20)

        rate = rospy.Rate(20)
        antbotSpeed = antbotOdom()
