...
public:
    PublishOdom(){
        ...
        yunspeed_sub = n.subscribe("yun_speed", 1, &PublishOdom::sub_callrear, this);
        L = 0.4;
        W = 0.3;
        R = 0.12;
    }
    void sub_callrear(const yun_bringup::Odom::ConstPtr& input)
     {
         current_time=ros::Time::now();
         float vx = input->vx;//the x speed of the yun
         float vy = input->vy;//the y speed of the yun
         float vth = input->vth;//the thea speed of the yun
