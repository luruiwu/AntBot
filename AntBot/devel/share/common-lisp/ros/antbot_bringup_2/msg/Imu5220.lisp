...
(cl:defmethod cl:initialize-instance :after ((m <Imu5220>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Imu5220)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name antbot_bringup_2-msg:<Imu5220> is deprecated: use antbot_bringup_2-msg:Imu5220 instead.")))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <Imu5220>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader antbot_bringup_2-msg:angle-val is deprecated.  Use antbot_bringup_2-msg:angle instead.")
  (angle m))
