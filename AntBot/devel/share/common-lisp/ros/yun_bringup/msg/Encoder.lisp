...
(cl:defmethod cl:initialize-instance :after ((m <Encoder>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Encoder)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name yun_bringup-msg:<Encoder> is deprecated: use yun_bringup-msg:Encoder instead.")))

(cl:ensure-generic-function 'encoder-val :lambda-list '(m))
(cl:defmethod encoder-val ((m <Encoder>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yun_bringup-msg:encoder-val is deprecated.  Use yun_bringup-msg:encoder instead.")
  (encoder m))
