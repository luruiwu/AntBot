...
"""autogenerated by genpy from planner_msgs/GoToActionResult.msg. Do not edit."""
import sys
...
class GoToActionResult(genpy.Message):
  _md5sum = "41a322458f4dcaf4998157c08e61db47"
  _type = "planner_msgs/GoToActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','planner_msgs/GoToResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = planner_msgs.msg.GoToResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = planner_msgs.msg.GoToResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_i.pack(self.result.route_result))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.route_result,) = _struct_i.unpack(str[start:end])
      return self
