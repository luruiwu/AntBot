...
"""autogenerated by genpy from planner_msgs/GoToAction.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['planner_msgs/GoToActionGoal','planner_msgs/GoToActionResult','planner_msgs/GoToActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = planner_msgs.msg.GoToActionGoal()
      if self.action_result is None:
        self.action_result = planner_msgs.msg.GoToActionResult()
      if self.action_feedback is None:
        self.action_feedback = planner_msgs.msg.GoToActionFeedback()
    else:
      self.action_goal = planner_msgs.msg.GoToActionGoal()
      self.action_result = planner_msgs.msg.GoToActionResult()
      self.action_feedback = planner_msgs.msg.GoToActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_i3I.pack(_x.action_result.result.route_result, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_result.result.route_result, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
